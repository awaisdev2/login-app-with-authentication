                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input type="text" id="first_name" className="text-sm block w-full pl-10 p-2.5 bg-transparent border border-gray-300  font-bold rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full" placeholder="First Name" value={firstName} onChange={(event) => setFname(event.target.value)} />
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input type="text" id="last_name" className="text-sm block w-full pl-10 p-2.5 bg-transparent border border-gray-300  font-bold rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full" placeholder="Last Name" value={lastName} onChange={(event) => setLname(event.target.value)} />
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input type="email" name="email" id="email" className="text-sm block w-full pl-10 p-2.5 bg-transparent border border-gray-300  font-bold rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full" placeholder="name@company.com" value={username} onChange={(event) => setUsername(event.target.value)} />
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input type="password" name="password" id="password" placeholder="••••••••" className="text-sm block w-full pl-10 p-2.5 bg-transparent border border-gray-300  font-bold rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full" value={password} onChange={(event) => setPassword(event.target.value)} />
                                        </div>
                                    </div>
                                    <div className="flex items-start">
                                        <div className="flex items-center h-5">
                                            <input id="terms" aria-describedby="terms" type="checkbox" className="w-4 h-4 border border-gray-300 rounded bg-transparent focus:ring-3 focus:ring-blue-300" />
                                        </div>
